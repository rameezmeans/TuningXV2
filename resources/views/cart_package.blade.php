                ...
                <div class="details-box">
                  ...
                  @if(country_to_continent(Auth::user()->country) == 'Europe')
                    @if(Auth::user()->country != 'GR')
                      @if(Auth::user()->group->slug == 'VAT0-TuningX')
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 m-t-40">
              ...
              <div class="card" >
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><h4>€{{$price+($price*$tax)/100}}</h4></td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <form action="{{route('checkout.packages.stripe')}}" method="POST">
                    ...
                    <input type="hidden" name="price_without_tax" value="{{$price}}" >
                ...
                @if(Auth::user()->group->paypal_active == 1)
